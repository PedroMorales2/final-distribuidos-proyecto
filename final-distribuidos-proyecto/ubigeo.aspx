                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="200px">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="Eliminar" CommandArgument='<%# Eval("id_ubigeo") %>' CssClass="btn btn-danger btn-sm" OnClientClick="return confirmDelete();">Eliminar</asp:LinkButton>
                                </ItemTemplate>
                                <EditItemTemplate>
